...
import type { SyncStoreHook } from './note-detail-view';
import { NoteTagsView } from './note-tags-view';
...
export interface NotebookTimelineProps {
  useSyncStore: () => SyncStoreHook & {
    ensurePulled: (nbId: string) => Promise<boolean>;
    syncPull: (nbId: string, callback?: () => Promise<void>) => Promise<void>;
  };
