import { NoteService, parseNotebookId } from '@timenote/core';
...
export interface SyncStoreHook {
  isSyncing: boolean;
  syncPush: (nbId: string) => Promise<void>;
}
...
export function NoteDetailView({ useSyncStore, prefetch = 'none' }: NoteDetailViewProps) {
      ...
      <PageHeader
        leftActions={
          <Button variant="ghost" size="icon" asChild className="rounded-full">
            <Link to={`/s/${notebookToken}`} prefetch={prefetch} title="Back to Timeline">
