...
import { db, type SyncableTableName, TABLE_NAMES } from '../db';
import type { MenuItem as MenuItemType, NoteTag } from '../types';
import type { BackupData, DataApplyResult, SyncableEntity } from './sync/types';
